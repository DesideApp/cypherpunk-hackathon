  ...
  const SORT_FIELDS = new Set([
    ...
    const pipeline = [
      ...
      { $project: {
          ...
          tokensAdded: { $ifNull: ['$statsDoc.tokensAdded', 0] },
          blinkExecutes: { $ifNull: ['$statsDoc.blinkExecutes', 0] },
          naturalCommandsExecuted: { $ifNull: ['$statsDoc.naturalCommandsExecuted', 0] },
        }
      },
